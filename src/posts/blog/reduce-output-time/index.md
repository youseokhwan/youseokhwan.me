...
`String`에 모아서 한 번에 출력하면 시간을 꽤 단축할 수 있다.
...
백준의 경우, 문자열 끝에 있는 개행은 신경 쓰지 않아도 된다.

![baekjoon-judge.png](/baekjoon-judge.png)

## 시간 측정

요소의 개수를 20만 개로 가정하고 시간을 측정해보았다.
...
`String`에 모아서 한 번에 출력하는 경우 약 1.955초(5회 평균)로 측정되었다.

요소를 100만 개로 늘려도 각 10.687초, 9.990초(3회 평균)로 후자가 더 빠른 것을 확인할 수 있다.
